...
SOURCES = \
	__init__.py \
	time_editor.py time_editor_dialog.py

PLUGINNAME = time_editor

PY_FILES = \
	__init__.py \
	time_editor.py time_editor_dialog.py

UI_FILES = time_editor_dialog_base.ui
...
QGISDIR=/home/magellan/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
